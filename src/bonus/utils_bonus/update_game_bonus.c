...
/*   Updated: 2025/08/14 12:50:32 by rdel-fra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	update_game_over(t_game *game)
{
	...
	game->image->game_over = mlx_texture_to_image(game->mlx,
			game->texture->game_over);
...
static void	update_game_win(t_game *game)
{
	...
	game->image->game_win = mlx_texture_to_image(game->mlx,
			game->texture->game_win);
